    ...
    <div>
      ...
      >
        ...
        <div className="bg-[#0f002b] flex flex-col pb-4 gap-6 w-[485px] h-[720px] absolute left-[200px] items-start">
          <div className="bg-[#0e002b] flex flex-row justify-between w-full h-16 items-start pt-3 pl-5 pr-6">
            <div
            ...
            <img
              src="https://file.rendit.io/n/L0Hx8QvdYv4iAsHMufea.svg"
              alt="Icoutlineinfo"
              id="Icoutlineinfo"
              className="mt-1 w-6"
            />
          </div>
          <div className="flex flex-col ml-24 gap-16 w-3/5 items-start">
            <div className="relative flex flex-row ml-10 w-3/4 items-start">
              <img
                src="https://file.rendit.io/n/5ze2fxhcMwM6efNPJQij.svg"
                alt="Ellipse"
                id="Ellipse"
                className="w-[176px] h-[176px] absolute top-3 left-3"
              />
              <img
                src="https://file.rendit.io/n/RJyqCEjGdMEpyhb1FKmU.png"
                alt="Frame2"
                className="relative border"
              />
            </div>
            <div className="flex flex-col gap-12 w-full h-40 font-['Nunito_Sans'] items-start">
              ...
              <div className="flex flex-row justify-between ml-4 w-5/6 font-['Inter'] items-start">
                <div className="flex flex-col gap-2 w-16 items-start">
                  <div className="bg-white flex flex-row justify-center pt-5 w-16 h-16 items-start rounded-[40px]">
                    <img
                      src="https://file.rendit.io/n/wv0OmRxy6QImDsUi0Kka.svg"
                      alt="Tdesignapp"
                      id="Tdesignapp"
                      className="w-5"
                    />
                  </div>
                  <div className="text-center text-xs font-semibold text-white ml-1">
                    File
                  </div>
                </div>
                <div className="flex flex-col gap-2 w-16 items-start">
                  <div className="bg-white flex flex-row justify-center pt-5 w-16 h-16 items-start rounded-[40px]">
                    <img
                      src="https://file.rendit.io/n/yKe0iViniS8HCVkP8hmb.svg"
                      alt="Solargallerybold"
                      id="Solargallerybold"
                      className="w-5"
                    />
                  </div>
                  <div className="text-center text-xs font-semibold text-white ml-2">
                    Gallery
                  </div>
                </div>
                <div className="flex flex-col gap-2 w-16 font-['Inter'] items-start">
                  <div className="bg-white flex flex-row justify-center pt-5 w-16 h-16 items-start rounded-[40px]">
                    <img
                      src="https://file.rendit.io/n/KO2SIJAPAQ1SSmsV1kVD.svg"
                      alt="Icroundcamera"
                      id="Icroundcamera"
                      className="w-5"
                    />
                  </div>
                  <div className="text-center text-xs font-semibold text-white ml-3">
                    Camera
                  </div>
                </div>
              </div>
