    ...
    <>
      {isOpen ? (
        <div>
          ...
          <div
            id="AppContentRoot"
            className="overflow-hidden bg-[#0f002b] flex flex-row w-[390px] items-start lg:hidden md:hidden"
          >
            <div
              id="Ellipse"
      ...
      <div
        id="NewGameRoot"
        className="lg:bg-[#0f002b] lg:flex gap-8 lg:w-[1085px] lg:h-[720px] lg:items-center"
      >
        ...
        <div className="bg-white lg:flex flex-col pb-16 gap-6 lg:w-[200px] lg:h-[720px]  items-start hidden">
          ...
          <div className="lg:flex lg:flex-col lg:justify-center lg:mx-auto lg:gap-2 w-0 h-0 lg:w-[160px] lg:h-4/5 items-center">
            ...
            <Link
              ...
              className="border-solid border-[rgba(15,_0,_43,_0.3)] shadow-[0px_4px_4px_0px_rgba(0,_0,_0,_0.25)] bg-[#ffcc4d] flex flex- gap-2 w-full h-8 items-end py-[7px] px-3 border rounded-lg"
            >
              <img
                src={Profile}
                alt="SocialPersonOutline icon"
        ...
        {/* menue section ends */}
        {/* Profile section */}
        <div className="bg-[#fead3a] lg:flex flex-col pb-4 gap-6 w-[485px] h-[720px] absolute left-[200px] items-start hidden">
        ...
        {/* battle section */}
        <div className="bg-[#0F002B] lg:flex flex-col lg:w-[400px] lg:h-[691px] lg:absolute lg:left-[685px] pb-8 gap-8 rounded-[20px] hidden">
