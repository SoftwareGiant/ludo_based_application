  ...
  return (
    <div className="max-w-[480px] w-full min-h-screen h-full">
      ...
      <div className=" w-full max-w-[480px] bg-white  min-h-screen overflow-hidden relative">
        ...
        <div className="bg-white font-[Nunito-Sans] font-bold   p-8 flex flex-col justify-center items-center  gap-4">
          <p>Battle played 2hrs ago</p>
          <img src={trophy} className="w-20" />
          <div className="flex gap-4 justify-center items-center">
            ...
            <span className="font-[Nunito-Sans] font-bold">Vs</span>
            <div className="flex flex-col items-center">
              <img
                className="rounded-full w-16"
                src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=1780&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          ...
          <table className="flex flex-col">
           <tr className="flex "><td className="flex-1">Battle Type</td> <td className="flex-1 font-bold">
            Open Challenge
           </td>
            </tr> 
            <tr className="flex"><td className="flex-1">Entry Fee</td> <td className="flex-1 font-bold">
            ₹40
           </td>
            </tr> 
            <tr className="flex"><td className="flex-1"> Prize</td> <td className="flex-1 font-bold">
            ₹80
           </td>
            </tr> 
          </table>
