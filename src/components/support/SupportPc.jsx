    ...
    <>
      {isOpen ? (
        <div>
          ...
          <div className="border-solid bg-[#fead3a] flex flex-row justify-between w-[390px] h-16 items-start pt-3 px-5 border-b border-black/30 lg:hidden md:hidden">
          ...
          <div
            id="NewRootRoot"
            className="flex flex-row w-[390px] items-start lg:hidden md:hidden"
          >
            <div
              id="AppContent"
