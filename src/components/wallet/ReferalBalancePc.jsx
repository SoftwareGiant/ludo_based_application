          ...
          <div className="flex flex-col gap-6 w-full items-start">
            <div className="flex flex-col gap-5 w-full items-start">
              ...
              <div className="flex flex-row justify-between ml-20 w-2/3 items-start">
                ...
                <div className="flex flex-row gap-2 w-10 items-start">
                  <div className="text-center text-xl text-[#0f002b]">₹</div>
                  <div className="text-center text-xl text-[#0f002b]">23</div>
                </div>
              </div>
            </div>
            <div className="flex flex-col ml-20 gap-2 w-2/3 font-['Nunito_Sans'] items-start">
              ...
              <div className="flex flex-row justify-between ml-[210px] w-1/3 font-['Inter'] items-start">
                <div className="text-center font-['Nunito_Sans'] font-bold text-[rgba(15,_0,_43,_0.2)]">
                  Withdraw
                </div>
                <div className="text-center font-bold text-[rgba(15,_0,_43,_0.2)] mt-px">
                  ₹
                </div>
                <div className="text-center font-bold text-[rgba(15,_0,_43,_0.2)] mt-px">
                  23
...
export default ReferalBalancePc;
