  ...
  return (
    <>
      ...
      >
        ...
        <div className="bg-white flex flex-col pb-16 gap-6 md:w-[200px] md:h-[720px]  items-start">
          ...
          <div className="flex flex-col w-full items-start">
            <div className="relative flex flex-row justify-center w-full items-start">
              <div className="w-full h-48 bg-background bg-cover bg-50%_50% bg-blend-normal bg-no-repeat absolute top-0 left-0 md:flex flex-row items-center hidden">
            ...
            <div className="flex flex-col gap-6 w-full items-start">
              <div className="flex flex-col w-full items-start">
                ...
                <div className="bg-[#fead3a] flex flex-col pt-px w-full items-start">
                  <div className="shadow-[0px_0px_4px_0px_rgba(0,_0,_0,_0.25)] flex flex-row justify-center ml-[336px] pt-2 gap-1 w-1/3 h-8 items-start rounded-lg">
                    <img
        ...
        {/* battle section */}
        <div className="md:bg-[#0F002B] md:flex md:flex-col md:w-[400px] md:h-[691px] md:absolute md:left-[685px] md:pb-8 md:gap-8 md:rounded-[20px] hidden">
...
export default NotiFicationResp;
