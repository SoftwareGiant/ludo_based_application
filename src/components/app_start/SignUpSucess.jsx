...
const SignUpSucess = () => {
  return (
    <>
      {/* <div
        id="AppStartSuccessRoot"
        className="overflow-hidden bg-[#fead3a] flex flex-row gap-0 w-full font-['Oooh_Baby'] items-start"
      >
        <div className="bg-[#0f002b] flex flex-col justify-between w-1/2 h-[720px] items-start pt-20 pb-12 pl-24">
          <div className="flex flex-col ml-3 gap-20 w-3/4 items-start">
        ...
        <img
          src="https://file.rendit.io/n/PBptmbjCyYecBvKYMHUg.png"
          alt="Ludoindianmonumenttouch"
          className="mr-[-178.5px]"
        />
      </div> */}
