...
const CardClickInstance3 = () => {
  return (
    <div>
      ...
      <div className="shadow-[0px_0px_3px_0px_rgba(0,_0,_0,_0.25)] bg-[#0f002b] flex flex-row w-full h-[762px] items-start pt-5 px-16">
...
export default CardClickInstance3;
