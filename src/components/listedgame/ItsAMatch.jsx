        ...
        <div className="bg-[#0f002b] flex flex-col pb-4 gap-6 w-[485px] h-[720px] absolute left-[200px] items-start">
          <div className="bg-[#0f002b] flex flex-row justify-between w-full h-16 items-start pt-3 pl-5 pr-6">
            <div className="flex flex-row gap-5 w-2/5 items-start">
              ...
              >
                listed <span className="font-['Inter'] font-bold">Battles</span>
              </div>
            </div>
            <img
          ...
          <div className="relative flex flex-row justify-center ml-12 w-4/5 items-start">
            <div className="text-center text-4xl font-bold text-white w-full h-32 bg-[#0f002b] absolute top-24 left-0 flex flex-row justify-center pt-8 items-start">
              It’s a match!
            </div>
            <img
