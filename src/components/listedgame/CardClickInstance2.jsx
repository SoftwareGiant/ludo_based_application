...
const CardClickInstance2 = () => {
  return (
    <div>
      ...
      <div className="shadow-[0px_0px_3px_0px_rgba(0,_0,_0,_0.25)] bg-[#0f002b] flex flex-row justify-center pt-[304px] w-full h-[762px] items-start">
        <div className="text-6xl font-['Inter'] font-bold text-white">
          Battle
        </div>
      </div>
    </div>
...
export default CardClickInstance2;
