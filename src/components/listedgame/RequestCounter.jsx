  ...
  return (
    <div>
      ...
      <div className="shadow-[0px_0px_3px_0px_rgba(0,_0,_0,_0.25)] bg-[#0f002b] flex flex-col justify-between w-full h-[762px] items-start pt-5 pb-24">
        <div className="flex flex-col justify-between w-full h-[381px] items-start">
          ...
          <div className="text-center text-5xl font-['Inter'] font-bold text-[#00c300] bg-white flex flex-row justify-center ml-32 pt-8 w-1/3 h-32 items-start rounded-[60px]">
            45
          </div>
        </div>
