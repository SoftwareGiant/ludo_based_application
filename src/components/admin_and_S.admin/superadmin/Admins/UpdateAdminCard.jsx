          ...
          <div className="bg-white w-[826px] rounded-md shadow-lg z-50">
            <div className="flex px-2 items-center rounded-t-md bg-[#EEEEEE] w-full h-[80px] justify-between">
              <div className="flex items-center gap-2">
                ...
                <div className={`${role==="Admin" ? "bg-[#BFCAFF]" : "bg-[#A9E5C8]"}  px-2 p-1 rounded-md flex items-center text-[19.2px]`}>
                  {role}
                </div>
              ...
              <div className="flex items-center gap-2">
             {role==="Admin" &&  <div  onClick={closeModal} className="bg-[#F4F4F4] flex items-center justify-center hover:bg-blue-gray-100 text-white font-bold p-2 rounded-full w-[48px] h-[38.4px]">
                <img src={key}/> 
             </div>}  
