            ...
            <MenuList className="shadow-[0px_0px_4px_0px_rgba(0,_0,_0,_0.25)] bg-white w-[173px] h-[216px] p-0 m-0">
              <MenuItem className="flex items-center gap-2">
                <div className="flex items-center gap-[13px]">
                  <img
                    ...
                    src="https://www.stryx.com/cdn/shop/articles/man-looking-attractive.jpg?v=1666662774"
                    className="scale-x-110 cursor-pointer border border-white rounded-full w-6 h-6 overflow-hidden"
                  />
              ...
              <MenuItem className="flex items-center gap-2">
                <div className="flex items-center gap-[13px]">
                  ...
                  >
                    <img src={Setting} alt="Games" id="Games" className="w-6" />
                    <div
                      id="Notified"
              ...
              <MenuItem className="flex items-center gap-2">
                <div className="flex items-center gap-[13px]">
                  <img src={LogOut} alt="Logout" id="Logout" className="w-6" />
                  <div className="text-xs font-medium text-[#0f002b]">
                    Log Out
                  </div>
                </div>
