...
import UpdatewithdrawCard from "./UpdatewithdrawCard";
...
const EditWithdraw = ({ TABLE_ROWS ,setPage}) => {
    ...
    <div>
      <div className="bg-[#F4F4F4]  py-1 px-4 flex pt-2 items-center justify-between  gap-4">
        ...
        <div className="flex gap-2 font-[Inter] font-medium text-[16px]">
              ...
              <Stats />
              <div onClick={()=>setPage("withdraw")} className="shadow-sm  h-[32px] justify-between p-1 bg-[#F4F4F4] flex items-center  border rounded-lg">
