          ...
          <div className="bg-white w-[826px] rounded-md shadow-lg z-50">
            <div className="flex px-2 items-center rounded-t-md bg-[#EEEEEE] w-full h-[80px] justify-between">
              ...
              <Icon icon="circum:edit" width="24" />
                ...
                <span className="pl-2">UID {id}</span>
              </div>
            ...
            <div className="w-full h-[465px] flex ">
                <div className="flex flex-col justify-center items-center m-auto text-[#0F002B] flex-1 font-[Nunito-Sans]">
                    <img alt="user" className="w-[200px] h-[200px] rounded-full"  src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dXNlcnxlbnwwfHwwfHx8MA%3D%3D"/>
              <span className="flex items-center font-bold text-[30px]">{name}     <Icon icon="bitcoin-icons:verify-outline" width="26"/></span>
