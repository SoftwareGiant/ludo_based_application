...
const SAdminLogin = () => {
  return (
    <>
      <div className="flex w-full h-[100vh] py-[135px] px-[186px] justify-center items-center flex-shrink-0 bg-[rgba(40,_189,_117,_0.40)] ">
        <div className="w-[713px] h-[451px] flex-shrink-0 rounded-[20px] border border-solid border-black border-opacity-20 backdrop-blur-[30px] bg-[rgba(255,_255,_2555,_0.28)]">
          ...
          <div className="inline-flex items-center gap-2 w-[125px] h-10 mt-6 ml-6">
            <div className="flex w-[62px] h-full py-1 pr-6 pl-6 items-center flex-shrink-0 rounded-[20px] border-2 border-solid border-black border-opacity-20 bg-[#28BD75]">
              <div className="flex w-9 h-9 p-[6px] justify-center items-center flex-shrink-0 rounded-[18px] border-2 border-solid border-white bg-[#28BD75]">
                <img src={AdminLogo} alt="" className="w-6 h-6" />
              </div>
            </div>
            <p className="text-[#28BD75] text-center text-base font-['Inter'] font-bold leading-normal">
              SUPER
            </p>
            <p className="text-[#28BD75] text-center text-base font-['Inter'] font-bold leading-normal">
              ADMIN
          ...
          <div className="inline-flex flex-col items-center gap-6 absolute top-[100.5px] left-[56px] w-[272px] h-[251px]">
            ...
            <div className="items-center font-medium text-white flex py-3 px-5 gap-4 justify-center w-[104px] h-[43px] border-2 border-solid border-white rounded-[30px] bg-[#28BD75]">
              Proceed
            </div>
          </div>
          <p className="w-[90px] h-[19px] text-black font-['Inter'] text-base font-normal leading-normal text-center absolute top-[376px] left-[148px] ">
            Need Help?
          </p>
          {/* side image */}
          <div></div>
