...
const AdminSupportChat = () => {
  ...
  return (
    <div className="flex-1 pb-4 bg-transparent  w-full   justify-between flex flex-col h-[92%]">
      <div className="z-10 flex border-b border-[#0f002b] justify-between py-2 px-4  items-center   w-full">
      ...
      <div className="border-t-2  z-10 border-[#0f002b] px-4 pt-4 mb-2 sm:mb-0">
        <form
